...
def getSources(url):
    ...
    for link in links:
        ...
        if 'myfile' in linktext or 'myflie' in linktext or 'videomega' in linktext or 'vidzi' in linktext or 'allmyvideos' in linktext or 'streamcloud' in linktext or 'vidto' in linktext or 'nowvideo' in linktext or 'dailymotion' in linktext:
